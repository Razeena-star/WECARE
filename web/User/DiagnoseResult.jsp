                    ...
                    <tr>
                       ...
                       <th>Symptoms</th>
                        ...
                        <th>To Date</th>
                         ...
                         <%
                        String sell = "select * from tbl_viraldiseasereport v  inner join tbl_familymembers fm on fm.member_id=v.member_id inner join tbl_viraldisease vd on v.vd_id=vd.vd_id inner join tbl_viraldiseasereportrslt vrr on v.vdr_id=vrr.vdr_id where fm.family_id='"+session.getAttribute("uid")+"'";
                        int i = 0;
